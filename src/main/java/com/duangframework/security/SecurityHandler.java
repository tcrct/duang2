...
//    private static String DUANG_AUTH_KEY;
//
//
...
//            throw new MvcException(DUANG_AUTH_KEY + " validation not passed");
//        }
...
//            String userId = SecurityKit.duang().id(key).get().getUserId();
//            Set<String> securitySet = SecurityKit.duang().id(userId).getAuths();
...
//        if(ToolsKit.isEmpty(DUANG_AUTH_KEY)) {
//            DUANG_AUTH_KEY = PropKit.get(ConstEnums.PROPERTIES.AUTHORIZATION_KEY.getValue(), "duang-auth");
//        }
//        String authorizationString = request.getHeader(DUANG_AUTH_KEY);
//        if(ToolsKit.isNotEmpty(authorizationString) && authorizationString.startsWith(AUTHORIZATION_HEADER_PREFIX)) {
//            return true;
//        }
//        return false;
//    }
...
//        String authorization = PropKit.get(ConstEnums.PROPERTIES.AUTHORIZATION_VALUE.getValue());
